...
pub const HttpClientSendError = HttpClientCreateRequestError || HttpClientReadResponseError || HttpClientParseResponseError || std.Io.Writer.Error || error{CantSendRequestTwice};
